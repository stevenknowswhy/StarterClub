...
export type Database = {
    ...
    public: {
        ...
        Enums: {
            ...
            waitlist_status: "pending" | "approved" | "waitlisted" | "contacted" | "archived";
        };
        CompositeTypes: {
            [_ in never]: never;
        };
...
export declare const Constants: {
    readonly public: {
        readonly Enums: {
            readonly inquiry_status: readonly ["new", "viewed", "contacted", "converted", "rejected"];
            readonly submission_source: readonly ["main_form", "modal_popup", "other"];
            readonly waitlist_status: readonly ["pending", "approved", "waitlisted", "contacted", "archived"];
        };
    };
};
export {};
